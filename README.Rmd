...
[![Codecov test coverage](https://codecov.io/gh/robertdj/RDP/branch/master/graph/badge.svg)](https://codecov.io/gh/robertdj/RDP?branch=master)
<!-- badges: end -->
...
In this example we see from the [{bench} package](https://bench.r-lib.org) summary that {RDP} is several 1000 times faster and use only a fraction of the memory.
