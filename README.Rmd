...
An example from the Wikipedia page linked to above with a description of the algorithm.
The original line is the black and the approximating line is red.
